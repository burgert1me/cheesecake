...
define(SQLLOG, 'daniel');		//Table (NOT DATABASE) used by image board
define(SQLHOST, 'localhost');		//MySQL server address, usually localhost
define(SQLUSER, 'daniel');		//MySQL user (must be changed)
define(SQLPASS, 'daniel');		//MySQL user's password (must be changed)
define(SQLDB, 'daniel');		//Database used by image board
define(ADMIN_PASS, 'daniel');	//Janitor password  (CHANGE THIS YO)
